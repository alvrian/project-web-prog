<x-layout>
          ...
          <div style="background-color: #E9F0E4;width: 85vw;height: 38rem;border-radius:12px;margin:1rem;padding:2rem;">
            ...
            <a href="#">
              <button id="home-button-explore"
                style="background-color: #D9D9D9;font-size: 18px;font-weight: 400;position: absolute;right: 3.5%;bottom: 5%;padding:4px 2rem;border-radius: 8px;border: none;">
                Explore
              </button>
            </a>
          </div>
  ...
  <div class="card d-flex flex-row"
    style="width:85vw;box-shadow: 5px 7px 8px 0px rgba(163,163,163,0.17);background-color:#F0EEEF;border: none;">
