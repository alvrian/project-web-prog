    ...
    <div class="container">
        ...
        <form action="{{ route('compost.index') }}" method="GET" class="mb-4">
            <div class="row d-flex justify-content-center">
                <div class="col-md-3">
                    <input type="text" name="search" class="form-control" placeholder="Search by Producer Name" value="{{ request('search') }}">
                </div>
                <div class="col-md-3">
                    <input type="text" name="compost_type" class="form-control" placeholder="Compost Type (e.g., Vermicompost)" value="{{ request('compost_type') }}">
                </div>
                <div class="col-md-2">
        ...
        <div class="row">
            @foreach($compostEntries as $entry)
                    ...
                    <div class="card position-relative">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                ...
                                @else
                                    <button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#priceModal{{ $entry->id }}">
                                        Set Price
                                    </button>
                                @endif
                            </p>
                ...
                <div class="modal fade" id="priceModal{{ $entry->id }}" tabindex="-1" aria-labelledby="priceModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="priceModalLabel">Set Price for {{ $entry->compost_types_produced }}</h5>
                            ...
                            <div class="modal-body">
                                <form id="priceForm{{ $entry->id }}" action="{{ route('price.store') }}" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" name="price_per_subscription_3" class="form-control" min="0" step="0.01" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="price_per_subscription_6" class="form-label">6-Month Subscription</label>
                                        <input type="number" name="price_per_subscription_6" class="form-control" min="0" step="0.01" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="price_per_subscription_9" class="form-label">9-Month Subscription</label>
                                        <input type="number" name="price_per_subscription_9" class="form-control" min="0" step="0.01" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="price_per_subscription_12" class="form-label">12-Month Subscription</label>
                                        <input type="number" name="price_per_subscription_12" class="form-control" min="0" step="0.01" required>
                                    </div>
