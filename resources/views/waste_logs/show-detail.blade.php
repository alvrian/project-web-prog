                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                ...
                                <select name="SubscriptionType" id="SubscriptionType" class="form-select" required>
                                    ...
                                    <option value="3">3 Months - ${{ $wasteLog->priceList->price_per_subscription_3 }}</option>
                                    <option value="6">6 Months - ${{ $wasteLog->priceList->price_per_subscription_6 }}</option>
                                    <option value="9">9 Months - ${{ $wasteLog->priceList->price_per_subscription_9 }}</option>
                                    <option value="12">12 Months - ${{ $wasteLog->priceList->price_per_subscription_12 }}</option>
                                </select>
                            </div>
